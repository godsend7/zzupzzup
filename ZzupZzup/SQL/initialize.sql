...
-- 테이블 자료 입력
-- member
INSERT INTO member(member_id, member_role, password, member_name, member_phone, login_type, age_range, gender, nickname, status_message, activity_score, manner_score, reg_date) VALUES ('admin@admin.com', 'admin', '1234', '관리자', '010-1111-0000','1', '20대', 'female', 'admin', '-', '0', '0', now());
INSERT INTO member(member_id, member_role, password, member_name, member_phone, login_type, age_range, gender, nickname, status_message, activity_score, manner_score, reg_date) VALUES ('user01@zzupzzup.com', 'user', '1234', 'user01', '010-0000-0001','1', '20대', 'male', 'user01', '-', '0', '0', now());
INSERT INTO member(member_id, member_role, password, member_name, member_phone, login_type, age_range, gender, nickname, status_message, activity_score, manner_score, reg_date) VALUES ('user02@zzupzzup.com', 'user', '1234', 'user02', '010-0000-0002','1', '30대', 'male', 'user02', '-', '0', '0', now());
INSERT INTO member(member_id, member_role, password, member_name, member_phone, login_type, age_range, gender, nickname, status_message, activity_score, manner_score, reg_date) VALUES ('owner01@zzupzzup.com', 'owner', '1234', 'owner01', '010-0000-0003','1', '30대', 'male', 'user02', '-', '0', '0', now());
INSERT INTO member(member_id, member_role, password, member_name, member_phone, login_type, age_range, gender, nickname, status_message, activity_score, manner_score, reg_date) VALUES ('hihi@a.com', 'user', '1234', '조영주1', '010-0000-0000','1', '10대', 'female', 'czro', '-', '0', '0', now());
