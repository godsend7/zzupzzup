					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col">
								...
								<a href="#" id="write" class="button svg-btn btn-sm float-right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
							...
							<div class="col-md-4">
								<div class="card mb-1 shadow-sm">
									...
									<div class="card-body">
										...
										<p class="card-text" style="text-overflow:ellipsis; overflow: hidden; white-space: nowrap;">${community.postText}</p>
