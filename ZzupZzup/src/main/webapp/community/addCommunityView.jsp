			...
			$.ajax({
				...
				success:function(data){
					console.log(data);
				 	...
				 	$("#addCommunity").attr("method" , "POST").attr("action" , "/community/addCommunity").attr("enctype", "multipart/form-data").attr("accept-charset","UTF-8").submit();
		...
		<div id="main">
			<div class="inner">
				...
				<div class="container">
					...
					<h2 class="mb-5">게시물 등록하기</h2>
					
					<form class="form-horizontal" id="addCommunity">
					<!-- 
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							...
							<textarea id="postText" name="postText" placeholder="게시물 소개글" rows="3" style="resize: none; height: 20em;"></textarea>
					...
					<div class="text-center mt-5">
						<button type="button" class="button secondary mr-3" id="button3">
						...
						<button type="button" class="button primary" id="button1">
