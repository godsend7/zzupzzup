...
public interface ReservationService {
	...
	// SELECT LIST
	public Map<String, Object> listReservation(Search search, String memberId, String restaurantNo) throws Exception ;//관리자가 보는 목록
	
	// SELECT LIST
	public Map<String, Object> listMyReservation(Search search, String memberId, String restaurantNo) throws Exception ;//업주, 유저가 보는 목록. 업주는 레스토랑이 여러개 있을 수있어서 레스토랑no값을 넣어줌	
