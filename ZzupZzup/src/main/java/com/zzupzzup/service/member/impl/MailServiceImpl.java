...
//				+"<style> .button.primary { background-color: #f56a6a; box-shadow: none; color: #ffffff; box-radius: 20px; width: 150px; height: 40px; text-align:center; font-size: 15px;}</style>"
				+"</head>"
				+"<body class='is-preload'><div id='wrapper'><div id='main'><div class='inner'>"
				+"<section id='reset-pwd-body'><div class='container'>"
				+"<div align='center'>"
				+"<img src='https://zzupzzup.s3.ap-northeast-2.amazonaws.com/common/favicon.ico'><br/><h4 style='color: #000;'>안녕하세요. 쩝쩝듀스101입니다.<br/>아래 버튼을 클릭 하여 비밀번호를 설정해주세요.</h4>"
				+"<a href='" + request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/member/setPassword.jsp?memberId="+to+"'>"
				+"<input type='button' class='button primary' value='비밀번호 재설정' style='background-color: #f56a6a; box-shadow: none; color: #ffffff; box-radius: 20px; width: 150px; height: 40px; text-align: center; font-size: 15px;'>"
				+"</a></div>"
